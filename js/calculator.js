...
calculatorForm.addEventListener('submit', function(event) {
  ...
  //Selectors
   ...
   const websiteCar  = document.querySelector('#calculator-form-input-cart input:checked');
  ...
  //Values
   ...
   const websiteCarValue = convertCartOptionToPrice(websiteCar.value);
   const websiteReceptiontValue = convertReceptiontOptionToPrice(websiteReceptiont.value);

   
  
   const totalSum = websiteTypeValue + technologiesValue + websiteCarValue +  websiteReceptiontValue;
   renderSum(totalSum);
   calculateSum();
});
